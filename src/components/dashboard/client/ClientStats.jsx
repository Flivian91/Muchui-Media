...
function ClientStats() {
  return (
    <div className="flex items-center gap-5 justify-between">
      <div className="flex items-center gap-5 px-4 border shadow-sm rounded bg-secondary/30 py-1">
      ...
      <div className="flex items-center gap-5 px-4 border shadow-sm rounded bg-green-500/30 py-1">
        <span className="p-2 rounded-full bg-surface">
      ...
      <div className="flex items-center gap-5 px-4 border shadow-sm rounded bg-pink-500/40 py-1">
        <span className="p-2 rounded-full bg-surface">
          <BiLike fontSize={23} />
        </span>
        <div className="flex flex-col items-center gap-1 border-l border-gray-400 pl-3">
